	...
	methods: {
		...
		updateDependencyStatus: function updateDependencyStatus() {
			...
			var _loop = function _loop(dependency) {
				...
				// #93 compatability with flexible-content, which adds a generated attribute for each field
				var dependencyValue = _this2.dependencyValues[_this2.field.attribute + dependency.field];

				if (dependency.hasOwnProperty('existsIn') && Array.isArray(dependencyValue) && dependencyValue.findIndex(function (item) {
					return item[dependency.property] == dependency.existsIn;
				}) > -1) {
					_this2.dependenciesSatisfied = true;
					return {
						v: void 0
					};
				}
